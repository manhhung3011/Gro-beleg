...
foregroundDetector = vision.ForegroundDetector(  'NumTrainingFrames', 150,'NumGaussians', 2);

videoReader = vision.VideoFileReader('videocrop.mp4');
for i = 1:1000 % Run on first 150 frames to learn background
...
%%
result = insertShape(frame, 'Point', bbox, 'Color', 'green');
